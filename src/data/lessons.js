...
export const LESSONS = [
  {
    ...
    phrases: [
      { en: "My name is Malika.", uz: "Менинг исмим Малика." },
      { en: "I am ten years old.", uz: "Мен ўн ёшдаман." },
      { en: "I am from Bukhara.", uz: "Мен Бухородан бўламан." },
      { en: "I live in Tashkent.", uz: "Мен Тошкентда яшайман." },
    ...
    dialogue: {
      ...
      lines: [
        ...
        { speaker: "Malika", en: "Hi! My name is Malika.", uz: "Салом! Менинг исмим Малика." },
        { speaker: "Anvar", en: "Nice to meet you. How old are you?", uz: "Танишганимдан хурсандман. Неча ёшдасиз?" },
        { speaker: "Malika", en: "I am ten years old. And you?", uz: "Мен ўн ёшдаман. Сиз-чи?" },
        { speaker: "Anvar", en: "I am eleven. Where are you from?", uz: "Мен ўн бир ёшдаман. Сиз қаердансиз?" },
        { speaker: "Malika", en: "I am from Bukhara. I live in Tashkent now.", uz: "Мен Бухородан бўламан. Ҳозир Тошкентда яшайман." },
        { speaker: "Anvar", en: "I am happy to meet you, Malika!", uz: "Сиз билан танишганимдан хурсандман, Малика!" },
        { speaker: "Malika", en: "Me too!", uz: "Мен ҳам!" },
      ],
    },
    homeworkPrompt:
      "Ўзингиз ҳақингизда 3-4 та гап ёзинг: исмингиз, ёшингиз, қаерданлигингиз ва бугун ўзингизни қандай ҳис қилаётганингиз.",
  },

  {
    ...
    homeworkPrompt:
      "Оилангиз ҳақида 3-4 та гап ёзинг: оилангизда неча киши бор, ота-онангиз ким бўлиб ишлайди.",
  },

  {
    ...
    homeworkPrompt:
      "Кунингиз ҳақида ёзинг: соат нечада уйғонасиз, мактабга қачон борасиз, кечқурун нима қиласиз.",
  },

  {
    ...
    homeworkPrompt:
      "Мактабингиз ва дўстларингиз ҳақида ёзинг: севимли фанингиз нима, энг яхши дўстингиз ким.",
  },

  {
    ...
    homeworkPrompt:
      "Севимли нарсаларингиз ҳақида ёзинг: ранг, овқат, ҳайвон, спорт ёки ўйин.",
  },
];
