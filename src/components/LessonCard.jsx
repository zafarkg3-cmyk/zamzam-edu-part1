...
const FEEDBACK_STYLE = {
  pending: { text: "⏳ Ўқитувчи ҳали кўрмади (балл кутилмоқда)", cls: "text-ink-faint" },
  approved: { text: "✅ Ўқитувчи: Аъло! ⭐ +10 балл қўшилди", cls: "text-leaf-deep" },
  needs_revision: { text: "🔄 Ўқитувчи: тузатиш керак (балл йўқ)", cls: "text-coral-deep" },
};
